...
function Right({ chooseTrack, spotifyApi }) {
	...
	return (
		<section 
			className='w-[300px] hidden md:block h-auto
			p-4 bg-gray-900 space-y-8'>
			<div className='flex space-x-2 items-center justify-between'>
				{/* Icons */}
				<div
					className='flex items-center space-x-4 border-2 
          border-[#262626] rounded-full h-12 py-3 px-4'
				>
          ...
          h-[250px] md:h-[400px] scrollbar-hide'
				>
