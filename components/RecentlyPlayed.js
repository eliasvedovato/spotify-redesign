...
function RecentlyPlayed({ track, chooseTrack }) {
	...
	return (
		<div className='flex items-center space-x-3 text-start' onClick={handlePlay}>
			<img
				src={track.albumUrl}
				alt=''
			...
			<div>
				<h4
					className='text-white text-[13px] mb-0.5 font-semibold 
          hover:underline cursor-pointer truncate max-w-[150px]'
				>
					{track.title}
				</h4>
